...
const ForgotPassword = () => {
    ...
    const handleSubmit = async (e) => { 
        ...
        try {
            setLoading(true)
            const response = await fetch(`${url}api/v1/forgotPassword`, {
                method: 'POST',
                headers: {
  ...
  return (
    ...
    <div className="w-full gap-y-2 flex flex-col justify-center">
      <h1 className="text-[25px] font-semibold pb-6 mt-14 px-10 md:text-center">Forgot <span className="text-[#EA1588] ">Password</span></h1>
     <ToastContainer />
      <form 
