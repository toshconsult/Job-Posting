      ...
      {loading ? (
        ...
        <div
          className={
            modalOpen
              ? "border-0"
              : "flex h-full md:h-[90vh] w-[98%]  md:w-[70%] mx-auto justify-center border-2 border-[#dfe4fc] rounded-2xl shadow-md items-center "
          }
        >
          <img
            ...
            className={
              modalOpen
                ? "hidden"
                : " h-full w-[45%] object-fit rounded-2xl hidden md:flex"
            }
          />
          <div
            className={
              modalOpen
                ? "border-0"
                : "w-full gap-y-2 flex flex-col justify-center rounded-2xl  p-6 md:p-10 lg:p-14 mx-auto mt-10 md:w-[400px] lg:w-[500px]"
            }
          >
       ...
       text-white hover:text-black hover:border-2 hover:border-[#F3F5FF]"
            ...
            <div className="flex flex-col gap-y-2 mt-4">
              <Link to="/forgot-password" className="text-center text-blue-600">
                Forgot Password
              </Link>
              <p className="text-center">
                ...
                <button
                  ...
                  onClick={modalOpen ? () => setOpenModal(true) : () => goto()}
                >
                  Sign Up
                </button>
              </p>
