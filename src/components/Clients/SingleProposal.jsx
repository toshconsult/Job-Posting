          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <button className="bg-gray-300 px-4 rounded-3xl ">
                ₦{proposal?.price?.toLocaleString("en-NG")}
              </button>
            </div>
            <div>
              <button
                onClick={assign}
                className={`${proposal?.status === "accepted" 
                  ? "cursor-not-allowed hover:bg-gray-300 bg-gray-300" 
                  : "cursor-pointer hover:bg-white hover:text-black hover:border hover:border-gray-200"
                } bg-blue-900 px-4 py-2 rounded-3xl text-white`}
                 >
                Assign Task
              </button>
            </div>
